                            ...
                            <motion.tr
                              ...
                              <td className="p-4 align-middle">
                                <select
                                  ...
                                  disabled={userData.privilege?.toLowerCase() === "read" ? true : false}
                                >
                                  <option
                              ...
                              <td className="px-4 py-3 font-medium text-violet-900 align-middle">
                                <div className="flex items-center justify-center h-full">
                                  {isUpdating ? (
                                    ...
                                    <label
                                      className={` relative inline-flex items-center gap-2 ${!assignment.busDocId || userData.privilege?.toLowerCase() === "read" ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer hover:opacity-90'} `}
                                    >
                                      <input
                                        type="checkbox"
                                        ...
                                        disabled={!assignment.busDocId || userData.privilege?.toLowerCase() === "read" ? true : false}
