...
import {
    User, VenusAndMars, Mail, Phone, GraduationCapIcon, Hash, CalendarDays, Ticket, HomeIcon, CreditCardIcon, Utensils, Bus, HeartPulseIcon
} from "lucide-react"
import { InputField } from './InputField';
import { SelectField } from './SelectField';

export default function PersonalInfo({ formData, setFormData, student }) {
    return (
        <>
