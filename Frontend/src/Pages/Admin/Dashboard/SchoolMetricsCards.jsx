...
//                     // Check if transaction date is today and status is completed
...
//                     if (tx.academicYear === currentYear && tx.status === 'completed') {
            ...
            studSnap.forEach(docSnap => {
                ...
                if (isActive) {
                    ...
                    (s.transactions || []).forEach(tx => {
                        ...
                        // All-time completed transactions for current year (for active students only)
