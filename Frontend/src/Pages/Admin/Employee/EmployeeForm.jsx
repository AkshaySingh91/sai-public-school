...
//       <div>
//       {/* Form fields here */}
//       <button onClick={onClose} className="mt-4 text-sm text-red-500">Cancel</button>
//     </div>
...
//             className="p-3 border rounded-md focus:ring-2 focus:ring-green-300 focus:outline-none"
//             required
//           />
//           <input
//             type="text"
...
//           className="w-full p-3 border rounded-md focus:ring-2 focus:ring-green-300 focus:outline-none"
//         />
