...
const EmployeeDetail = () => {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto w-full  rounded-2xl shadow-lg overflow-hidden ">
        <div className="grid grid-cols-1 w-full  lg:grid-cols-3 gap-8 p-8 relative">
          <div className="lg:col-span-1 w-full bg-violet-50 rounded-xl p-6 text-center  sticky top-0 left-0">
            <div className="mb-6 ">
            ...
            <div className="space-y-2 text-sm">
              ...
              <p>
                <span className="font-semibold text-violet-700">Type:</span>{" "}
                {employee.type}
              </p>
              <p>
                <span className="font-semibold text-violet-700">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <select
                      value={
                        isCustomDesignation ? "Other" : employee.designation
                      }
                      onChange={(e) => {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleChange("addharCardNo", e.target.value)
                      }
                      className="w-full p-3 border border-violet-200 rounded-lg focus:ring-2 focus:ring-violet-500"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-3">
                      <button
                        type="button"
                        onClick={() =>
                          handleChange("webAccess", !employee.webAccess)
                        }
                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                          employee.webAccess ? "bg-violet-600" : "bg-gray-200"
                        }`}
                      >
                        <span
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-3">
                      <button
                        ...
                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                          employee.active ? "bg-green-600" : "bg-red-600"
                        }`}
                      >
                        <span
                          className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
